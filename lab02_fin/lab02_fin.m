...
%% se ena zipped fakelo "username_erg2.zip"
% clear all;
% diary erg2
% 
% 
...
clear; % GIA NA KAQARISH H MNHMH KAI OLES OI METABLHTES
...
%% TO KOSTOS 4 PROIONTWN POU PARAGOYN DYO ETAIREIES, PERIGRAFETAI APO TO DIANYSMA costos 
%% OI POSOTHTES POU KALEITAI NA PARAGEI KAQE ETAIREIA, DIDETAI STON PINAKA posothtes
...
%% OI PINAKES c3 KAI c4 EINAI 5X2 KAI OI DYO, TO AQROISMA TOYS, EINAI O PINAKAS....
c3,c4
prosqesh = c3 + c4

%% POLLAPLASIASMOS PINAKA ME PINAKA (ORISMOS OPWS STA MAQHMATIKA), XRHSH TOY *
%% O a EINAI 2X4 KAI O p1 EINAI 4X3, ARA TO GINOMENO TOYS EINAI PINAKAS DIASTASEWN.....
a,p3
pol1 = a * p3

%% POLLAPLASIASMOS PINAKA ME PINAKA ANA STOIXEIO, XRHSH TOY .*
%% OI PINAKES c3 KAI c4 EINAI 5X2 KAI OI DYO, TO GINOMENO TOYS ANA STOIXEIO, EINAI O PINAKAS....
